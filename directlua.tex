...
* Lemma über Halme des Pushforwards im Fall des Vordrückens längs
  abgeschlossener Abbildungen
* viele Beispiele, möglichst explizite Beschreibungen der direkten Bilder
  (sich drehende Gitter usw.)
* dabei fallen vielleicht ein paar allgemeine Lemmas/Beobachtungen ab
* Wann ist das direkte Bild einer lokal konstanten Garbe wieder lokal
  konstant? (Vielleicht muss man über sog. konstruierbare Garben reden.
  Ich glaube, dass das Garben sind, die auf einer Stratifizierung des
  Raums lokal konstant sind. Auf so etwas sind wir schon gestoßen, etwa
  bei unserem Torusbeispiel: Außerhalb der kritischen Punkte war die
  Garbe lokal konstant.)

4. Höhere direkte Bilder

* Definition höhere direkte Bilder
* viele Beispiele, wie man sie berechnet/möglichst explizit beschreibt

5. Serre-Spektralsequenz

* Definition
* viele Beispiele, auch mit Differentialen und Ringstruktur
* Kleinsche Flasche
* Unit sphere tangent bundle von Sphären
